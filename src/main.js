...
import { TestGestureP } from '@/scenes/TestGestureP';
...
const config = {
    ...
    scene: [PreloadScene, MenuScene, EggDefense, TestEffects, SpriteTestScene, DemoComponents, TestGestures, TestGestureP],
    render: {
        pixelArt: false,
        antialias: true
    }
