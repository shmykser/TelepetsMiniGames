export const defenseTypes = {
    ...
    pit: {
        name: 'Яма',
        health: 10,
        maxHealth: 100, // Большой максимум для расширений
        autoRepair: false, // Отключить автолечение
        radius: 1, // по размеру
        ...
        damage: 0,
        cooldown: 0, // уже в миллисекундах
        size: 3, // 2x2 по умолчанию
        texture: '🕳️', // fallback эмодзи ямы
        spriteKey: 'pit', // ключ для спрайта
        defaultSize: '64x64',
        specialProperties: {
