...
export const ITEMS = {
    heart: {
        ...
        dropChance: 0.15, // 15% - редкий предмет
    ...
    patch: {
        ...
        dropChance: 0.8, // 80% - обычный предмет
    ...
    doublepatch: {
        ...
        dropChance: 0.4, // 40% - средняя редкость
        texture: '🩹', // Эмодзи пластыря (fallback)
    ...
    shovel: {
        ...
        increase: 1,
        dropChance: 0.5, // 50% - редкий инструмент
    ...
    honey: {
        name: 'Мёд',
        description: 'останавливает всех врагов в радиусе. выпадает из улья',
        increase: 1, // не используется
        dropChance: 0.1,
        texture: '🍯', 
