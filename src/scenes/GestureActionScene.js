...
export class GestureActionScene extends Phaser.Scene {
    constructor() {
        ...
        Object.defineProperty(this, "instructionLabel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    createGameObjects() {
        ...
        const defenceConfigs = [
            { x: 300, y: 300, type: 'pit' },
            { x: width - 300, y: 300, type: 'stone' },
            { x: 300, y: height - 300, type: 'crack' }
        ];
