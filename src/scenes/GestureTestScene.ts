...
export class GestureTestScene extends Phaser.Scene {
  ...
  private gestureLabel!: Phaser.GameObjects.Text;
  private objectsLabel!: Phaser.GameObjects.Text;
  ...
  private createDefences(): void {
    ...
    const defenceConfigs = [
      ...
      },
      {
        ...
        y: 150,
        texture: 'defence',
        defenceType: 'madCucumber' as const,
        protectionRadius: 30
      },
      {
        health: -1,
  ...
  private getSwipeDirection(direction: number): string {
  ...
  private updateLabels(gesture: string, object: string): void {
